...
if __name__ == "__main__":
    ...
    parser.add_argument("--model", default="nametag3-czech-cnec2.0-240830", type=str, help="Model to use")
    parser.add_argument("--output", default="conll", type=str, help="Output format")
